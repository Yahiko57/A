...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Mencoba teori grup 300 member', body: `Click Here!`, sourceUrl: 'http://wa.me/6281283408836/', thumbnail: data }}, options })
    }
